...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col transition-colors duration-300">
      {/* Header */}
      <header className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-700 sticky top-0 z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center gap-5">
             <button 
               onClick={handleReturnToMenu} 
               className="p-2.5 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full text-gray-500 dark:text-gray-400 transition-colors" 
               title="Back to Menu"
             >
                <Home size={24} />
             </button>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-gradient-to-br from-red-600 to-red-500 rounded-xl flex items-center justify-center text-white shadow-lg shadow-red-500/30">
                <Video size={24} fill="currentColor" />
              </div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">TubeScribe <span className="text-red-600 dark:text-red-500">AI</span></h1>
            </div>
          </div>
          <div className="flex items-center gap-5">
            <button
              onClick={toggleTheme}
              className="p-3 rounded-full text-gray-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 transition-colors"
              title={isDarkMode ? "Switch to Light Mode" : "Switch to Dark Mode"}
            >
              {isDarkMode ? <Sun size={24} /> : <Moon size={24} />}
            </button>
            <div className="hidden sm:flex items-center gap-6 text-base font-medium text-gray-500 dark:text-gray-400">
               <span className="text-sm px-3 py-1.5 bg-gray-100 dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-700">YouTube Mode</span>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            {/* Controls */}
            {videoUrl && (
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 space-y-6 animate-fade-in-up delay-100 transition-colors">
                ...
                <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-xl border border-gray-200 dark:border-gray-600">
                  <label className="flex items-center gap-2 text-gray-700 dark:text-gray-300 font-bold text-sm uppercase tracking-wider mb-3">
                    <Globe size={16} />
                    Output Language
                  </label>
                  <div className="relative">
                    <select
                      ...
                      className="w-full appearance-none pl-4 pr-10 py-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-xl text-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none text-gray-900 dark:text-white cursor-pointer transition-shadow"
                    >
                  ...
                  {isTranslating ? (
                    <div className="mt-3 text-sm text-blue-600 dark:text-blue-400 flex items-center gap-2 font-medium">
                      <Ear size={14} />
                ...
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="flex items-center justify-between w-full px-5 py-5 bg-blue-50 dark:bg-blue-900/30 hover:bg-blue-100 dark:hover:bg-blue-900/50 text-blue-700 dark:text-blue-300 rounded-xl border border-blue-200 dark:border-blue-800 transition-all font-medium disabled:opacity-50 disabled:cursor-not-allowed group"
                  >
                    <span className="flex items-center gap-4 text-left">
                      ...
                      <div>
                        ...
                        <div className="text-sm opacity-85 font-normal">
                  ...
                  {/* Secondary Actions */}
                   <div className="grid grid-cols-2 gap-4">
                      <button
                        ...
                        className="flex flex-col items-center justify-center gap-3 px-3 py-6 bg-purple-50 dark:bg-purple-900/30 hover:bg-purple-100 dark:hover:bg-purple-900/50 text-purple-700 dark:text-purple-300 rounded-xl border border-purple-200 dark:border-purple-800 transition-all font-bold text-base disabled:opacity-50 disabled:cursor-not-allowed h-full"
                      ...
                      >
                       ...
                       <button
                        ...
                        className="flex flex-col items-center justify-center gap-3 px-3 py-6 bg-green-50 dark:bg-green-900/30 hover:bg-green-100 dark:hover:bg-green-900/50 text-green-700 dark:text-green-300 rounded-xl border border-green-200 dark:border-green-800 transition-all font-bold text-base disabled:opacity-50 disabled:cursor-not-allowed h-full"
          ...
          <div className="lg:col-span-7 h-full flex flex-col space-y-6">
            {/* Tabs */}
             {videoUrl && (
               <div className="flex items-center space-x-2 bg-gray-200/50 dark:bg-gray-800 p-2 rounded-xl w-fit overflow-x-auto max-w-full border border-gray-200 dark:border-gray-700">
                  <button
                    onClick={() => setActiveTab('transcript')}
                    className={`px-6 py-3 rounded-lg text-lg font-medium transition-all whitespace-nowrap ${
                  ...
                  <button
                    ...
                    className={`px-6 py-3 rounded-lg text-lg font-medium transition-all whitespace-nowrap flex items-center gap-2 ${
                      activeTab === 'chat' 
            ...
            <div className="flex-grow min-h-[800px]">
               ...
               {!videoUrl && (
                 <div className="h-full flex flex-col items-center justify-center text-gray-400 dark:text-gray-500 p-12 border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-2xl bg-white/50 dark:bg-gray-800/50 transition-colors">
                    <div className="w-24 h-24 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center mb-6 shadow-inner">
                       <ArrowRight size={40} className="text-gray-300 dark:text-gray-600" />
                    </div>
                    <p className="text-2xl font-medium">Paste a YouTube URL to get started</p>
                 </div>
               )}
            </div>
          </div>
